...
# Crear scoreboards
scoreboard objectives add contract trigger "Menú de Contratos"
...
tellraw @a ["",{"text":"[Sistema de Contratos] ","color":"gold","bold":true},{"text":"Usa ","color":"gray"},{"text":"/trigger contract","color":"yellow","clickEvent":{"action":"suggest_command","value":"/trigger contract"},"hoverEvent":{"action":"show_text","contents":"Click para sugerir el comando"}},{"text":" para abrir el menú","color":"gray"}]
